...
//         event.request.url.includes(`https://crm.lidenar.com/hanadb/api/products/price_list_product`) ||
//         event.request.url.includes(`https://crm.lidenar.com/hanadb/api/products/stock/`) ||
//         event.request.url.includes(`https://crm.lidenar.com/hanadb/api/orders/credit` )) {
