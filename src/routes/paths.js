...
export const PATH_DASHBOARD = {
    ...
    credito: {
        ...
        juridica_crear: path(ROOTS_DASHBOARD, '/credito/juridica/crear'),
        juridica_view: (id) => `${path(ROOTS_DASHBOARD, '/credito/juridica/actualizar')}?id=${id}`,
        natural_crear: path(ROOTS_DASHBOARD, '/credito/natural/crear'),
        natural_view: (id) => `${path(ROOTS_DASHBOARD, '/credito/natural/actualizar')}?id=${id}`,
    ...
    reports: {
        ...
        series_facturadas: path(ROOTS_DASHBOARD, '/reports/SeriesFacturadas'),
    },
    tevcol: {
