...
export default function SolicitudPDF({ data, user }) {
    ...
    console.log("NOMBRE_1: "+ data?.data?.empresa?.NOMBRE);
        ...
        <Page size="A4" style={styles.page}>
            ...
            <View style={styles.section_ch}>
                ...
                <View style={styles.gridContainer_ch}>
                    {documentosMap.map((doc, index) => {
                        const valorDocumento = data?.data?.documentos?.[doc.key];
            ...
            <View style={styles.section}>
                <Text style={styles.text}>
                    ...
                    relativa a su historial crediticio. De igual manera, {nombre_empresa} queda autorizado para realizar
                    revisiones
                    ...
                    que le amparan.
                    El suscrito reconoce que {nombre_empresa} sólo obtiene los datos personales de sus clientes ya sea
                    directamente y de
                    ...
                    el único propósito
                    de que {nombre_empresa} se encuentre en posibilidades de celebrar el contrato de crédito que, en su
                    caso y por acuerdo
                    mutuo con el solicitante se pretenda formalizar, para mantener y custodiar el expediente en
                    información respectiva.

                    Asimismo, {nombre_empresa}, podrá usar la información del suscrito en su carácter de solicitante para
                    contactarle,
                    ...
                    externos, en el
                    entendido de que {nombre_empresa} les proporcionará únicamente la información personal que necesiten
                    para llevar a cabo
                    los servicios, y que {nombre_empresa} les solicita que protejan dicha información y no la utilicen
                    para otros fines.
                    ...
                    Autorizo mediante este acto a la empresa {nombre_empresa} a compilar, almacenar, tratar, consultar, usar,
                    procesar,
                    ...
                    En cualquier momento, podré solicitar a la empresa {nombre_empresa} por escrito la modificación de mis
                    datos personales,
                    la misma será aplicable siempre y cuando sea formulada en los términos legales mediante una
                    comunicación escrita.

                    Toda la información que la empresa {nombre_empresa} mantenga, recolecte, reciba u obtenga y que me
                    concierna, de manera
                    directa o indirecta en forma verbal, escrita, gráfica, en medio magnético o bajo cualquier otra
                    forma, que no sea
                    de dominio público, deberá tener una base legal. En consecuencia, la empresa {nombre_empresa} tomará
                    todas las medidas
