        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    <Text style={styles.title}>AUTORIZACIÓN PERSONAS JURÍDICAS</Text>
                    ...
                    <Text style={styles.text}>con número de cédula: {data?.data?.data?.empresa?.RUC}</Text>
                    ...
                    <Text style={styles.text}>CI.: {data?.data?.data?.empresa?.RUC}</Text>
                </View>
